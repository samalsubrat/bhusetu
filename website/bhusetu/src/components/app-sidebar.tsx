...
const ROLE_NAV_MAPPING: Record<Role, (keyof typeof ALL_NAV_ITEMS)[]> = {
  ...
  REVENUE_INSPECTOR: ["OVERVIEW", "VERIFICATION_CASES", "FIELD_TASKS", "LAND_RECORDS", "ALL_LAND_RECORDS"],
  ADDITIONAL_TAHASILDAR: ["OVERVIEW", "VERIFICATION_CASES", "ALL_APPLICATIONS", "LAND_RECORDS", "ALL_LAND_RECORDS", "CASE_ACTIVITY_LOGS", "USERS"],
  TAHASILDAR: ["OVERVIEW", "VERIFICATION_CASES", "ALL_APPLICATIONS", "LAND_RECORDS", "ALL_LAND_RECORDS", "LOGS", "USERS"],
  COLLECTOR: ["OVERVIEW", "APPROVAL_STATS", "ALL_APPLICATIONS", "LAND_RECORDS", "ALL_LAND_RECORDS", "LOGS", "DISPUTE_CASES", "LAND_ANALYTICS", "USERS"],
  ADMIN: [
